...
import pytest
from contextunity.core.grpc_utils import _guess_local_ipv4, _redis_register_host
...
class TestRedisRegisterHost:
    def test_concrete_bind_host_is_reused(self) -> None:
        assert _redis_register_host("192.168.1.20") == "192.168.1.20"

    def test_bind_all_never_published(self) -> None:
        advertised = _redis_register_host("0.0.0.0")
