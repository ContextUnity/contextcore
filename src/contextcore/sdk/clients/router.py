...
def _ensure_protos():
    ...
    if context_unit_pb2 is None:
        try:
            ...
            from contextcore import router_pb2_grpc as router_grpc
...
class RouterClient:
    ...
    def _get_metadata(self, custom_metadata: dict | None = None) -> list[tuple[str, str]]:
        ...
        from contextcore.sdk.identity import mint_client_token
...
class SyncRouterClient:
    """Synchronous client for interacting with ContextRouter (e.g. for Django views)."""
