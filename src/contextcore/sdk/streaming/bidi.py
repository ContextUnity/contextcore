...
Projects use ``register_and_start()`` from ``contextcore.sdk.bootstrap``.
"""
...
def _run_stream(
    ...
    try:
        ...
        def request_generator():
            ...
            yield ready_unit.to_protobuf(context_unit_pb2)
            logger.info(
            ...
            while True:
                try:
                    ...
                    yield hb.to_protobuf(context_unit_pb2)
...
def _handle_execute(
    ...
    response_queue.put(resp_unit.to_protobuf(context_unit_pb2))
