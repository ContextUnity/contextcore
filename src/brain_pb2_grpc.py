...
class BrainServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRecentEpisodes = channel.unary_stream(
                '/contextbrain.BrainService/GetRecentEpisodes',
                request_serializer=context__unit__pb2.ContextUnit.SerializeToString,
                response_deserializer=context__unit__pb2.ContextUnit.FromString,
                _registered_method=True)
        ...
        self.GetUserFacts = channel.unary_stream(
                '/contextbrain.BrainService/GetUserFacts',
                request_serializer=context__unit__pb2.ContextUnit.SerializeToString,
                response_deserializer=context__unit__pb2.ContextUnit.FromString,
                _registered_method=True)
        self.LogTrace = channel.unary_unary(
                '/contextbrain.BrainService/LogTrace',
                request_serializer=context__unit__pb2.ContextUnit.SerializeToString,
                response_deserializer=context__unit__pb2.ContextUnit.FromString,
                _registered_method=True)
        self.GetTraces = channel.unary_stream(
                '/contextbrain.BrainService/GetTraces',
                request_serializer=context__unit__pb2.ContextUnit.SerializeToString,
                response_deserializer=context__unit__pb2.ContextUnit.FromString,
                _registered_method=True)
